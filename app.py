...
def authenticate_spotify():
    if "token_info" not in st.session_state:
        ...
        auth_code = st.text_input("Enter the code from the URL after login:")
        if auth_code:
            try:
        ...
        st.success("You're already authenticated with Spotify!")
...
if "token_info" not in st.session_state:
    ...
    if page == "Liked Songs & Discover New":
        st.header("Liked Songs & Discover New")
        ...
        st.header("Insights & Behavior")
        # Add insights logic here
        st.write("Insights feature under development.")
